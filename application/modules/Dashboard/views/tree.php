                                    ...
                                    <li>
                                        <div class="member-img">
                                            ...
                                            <span class="on-hover">
                                                ...
                                                Current Rank : R<?php echo ($user['rank']); ?> <br>
                                                Package Amount : <?php echo $user['total_package']; ?> <br>
                                                Total Business : <?php echo getBusiness($user['user_id']); ?> <br>
                                                Today Business : <?php echo getBusinessToday($user['user_id'], $date1); ?> <br>
                                                Monthly Business : <?php echo getBusinessMonth($user['user_id'], $date); ?> <br>
                                                <?php
                                                $wallet_balance = $this->User_model->get_single_record('tbl_wallet', 'user_id = "' . $user['user_id'] . '" ', 'ifnull(sum(amount),0) as wallet_balance');
                                                ?>
                                                Wallet Balance : <?php echo $wallet_balance['wallet_balance']; ?> <br>
                                                ...
                                                <li>
                                                    <div class="member-img">
                                                        ...
                                                        <span class="on-hover">
                                                            ...
                                                            <?php if($direct['rank'] > 0){?>
                                                            Current Rank : R<?php echo ($direct['rank']); ?> <br>
                                                            <?php }else{?>
                                                                Current Rank : No Rank  <br>
                                                                <?php }?>
                                                            Package Amount : <?php echo $direct['total_package']; ?> <br>
                                                            Total Business : <?php echo getBusiness($direct['user_id']); ?> <br>
                                                            Today Business : <?php echo getBusinessToday($direct['user_id'], $date1); ?> <br>
                                                            Monthly Business : <?php echo getBusinessMonth($direct['user_id'], $date); ?> <br>
                                                            <?php
                                                            $wallet_balance = $this->User_model->get_single_record('tbl_wallet', 'user_id = "' . $direct['user_id'] . '" ', 'ifnull(sum(amount),0) as wallet_balance');
                                                            ?>
                                                            Wallet Balance : <?php echo $wallet_balance['wallet_balance']; ?> <br>
                                                        </span>
                                                    </div>
                                                    <ul class="clearfix">
                                                        ...
                                                        foreach ($direct['sub_directs'] as $k => $sub_direct) {
                                                            //    pr($sub_direct);
                                                            $wallet_balance = $this->User_model->get_single_record('tbl_wallet', 'user_id = "' . $sub_direct['user_id'] . '" ', 'ifnull(sum(amount),0) as wallet_balance');
                                                            ...
                                                            <li>
                                                                <div class="member-img">
                                                                    ...
                                                                    <span class="on-hover">
                                                                        ...
                                                                        <?php if($sub_direct['rank'] > 0){?>
                                                                        Current Rank : R<?php echo ($sub_direct['rank']); ?> <br>
                                                                        <?php }else{?>
                                                                            Current Rank : No Rank  <br>
                                                                            <?php }?>
                                                                        Package Amount : <?php echo $sub_direct['total_package']; ?> <br>
                                                                        Total Business : <?php echo getBusiness($sub_direct['user_id']); ?> <br>
                                                                        Today Business : <?php echo getBusinessToday($sub_direct['user_id'], $date1); ?> <br>
                                                                        Monthly Business : <?php echo getBusinessMonth($sub_direct['user_id'], $date); ?> <br>
                                                                        <?php
                                                                        $wallet_balance = $this->User_model->get_single_record('tbl_wallet', 'user_id = "' . $sub_direct['user_id'] . '" ', 'ifnull(sum(amount),0) as wallet_balance');
                                                                        ?>
                                                                        E-Wallet Balance : <?php echo $wallet_balance['wallet_balance']; ?> <br>
