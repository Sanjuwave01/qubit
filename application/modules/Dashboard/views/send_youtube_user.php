...
<!--<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="#">Promotional </a></li>
<li class="breadcrumb-item active">Youtube Video</li>
</ul>-->
<!-- BEGIN page-header -->

<h2 class="page-titel"><spna style="">PROMOTIONAL</spna> / YOUTUBE VIDEO </h2>
<h1 class="page-header">
Youtube Video<small> promote dream21 by youtube video</small>
</h1>

<div class="row" id="divsmdt" style="display:none;">
    <div class="card col-12" id="divsocialmediamsg">
       </div>
       </div>


<div id="divsocialmedia" style="">
            <div class="row">
         <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="row">
                     <div class="col-lg-12">
                            <!--<h4 class="card-title">YouTube Task</h4>
                            <h6 class="card-subtitle againsing">Post your YouTube video url</h6>-->
                            <div class="jumbotron">
                              <ul id="YoutubeVideo" class="list col-12">

                                <li><a href="https://youtu.be/hat9xsg8Zno">https://youtu.be/hat9xsg8Zno </a> </li>

                                <hr>
                                <li> <a href="https://youtu.be/YREvnkGoA20"> https://youtu.be/YREvnkGoA20 </a></li>

                                <hr>
                                <li>  <a href="https://youtu.be/zn_CYR6GKjg">  https://youtu.be/zn_CYR6GKjg </a></li>

                                <hr>

                                <li><a href="https://youtu.be/-9WvgFZ7iBk">  https://youtu.be/-9WvgFZ7iBk </a></li>

                                <hr>

                                  <li><a href="https://youtu.be/qdn8136GksU">https://youtu.be/qdn8136GksU </a></li>
                              </ul>
