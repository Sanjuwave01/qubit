                                            ...
                                            <table class="table table-bordered table-striped dataTable" id="">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($users as $key => $user) {
                                                        $Rewards = $this->User_model->get_single_record('tbl_rewards',  'user_id ="' . $user['user_id'] . '" order by id desc LIMIT 1', '*'); ?>
                                                        <tr>
                                                            <td><?php echo $i; ?></td>
                                                            ...
                                                            <td><?php
                                                                ...
                                                                ?></td>
                                                             <td><?php
                                                                if ($user['userinfo']['rank'] > 0) { ?>
                                                                    R <?php echo $user['userinfo']['rank'];?>
                                                                <?php }else{ ?>
                                                                     No Rank
                                                               <?php } ?>
