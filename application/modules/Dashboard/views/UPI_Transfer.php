...
<div class="container-fliud">
        <div class="row">
            <div class="col-md-12">
            	<h2 class="box-title">UPI Transfer&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h2>
                    ...
                    <div class="row">
                                ...
                                <div class="col-md-6" style="padding-top: 10px; padding-left:30px;  padding-right:30px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="ctl00$ContentPlaceHolder1$txtmobno" type="text" maxlength="10" id="ContentPlaceHolder1_txtmobno" placeholder="Enter Mobile No." class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label>
                                           UPI No <span data-val-controltovalidate="ContentPlaceHolder1_txtamt" data-val-errormessage="Enter Recharge Amount." id="ContentPlaceHolder1_RequiredFieldValidator2" data-val="true" data-val-evaluationfunction="RequiredFieldValidatorEvaluateIsValid" data-val-initialvalue="" style="visibility:hidden;">*</span>
                                            :</label>
                                        <input name="ctl00$ContentPlaceHolder1$txtamt" type="text" maxlength="4" onchange="javascript:setTimeout('__doPostBack(\'ctl00$ContentPlaceHolder1$txtamt\',\'\')', 0)" onkeypress="if (WebForm_TextBoxKeyHandler(event) == false) return false;return onlyNumbers(this);" id="ContentPlaceHolder1_txtamt" placeholder="Enter UPI No." class="form-control">
                                    </div>


                                     <div class="form-group">
                                        <label>
                                           UPI Transfer Amount <span data-val-controltovalidate="ContentPlaceHolder1_txtamt" data-val-errormessage="Enter Recharge Amount." id="ContentPlaceHolder1_RequiredFieldValidator2" data-val="true" data-val-evaluationfunction="RequiredFieldValidatorEvaluateIsValid" data-val-initialvalue="" style="visibility:hidden;">*</span>
                                            :</label>
                                        <input name="ctl00$ContentPlaceHolder1$txtamt" type="text" maxlength="4" onchange="javascript:setTimeout('__doPostBack(\'ctl00$ContentPlaceHolder1$txtamt\',\'\')', 0)" onkeypress="if (WebForm_TextBoxKeyHandler(event) == false) return false;return onlyNumbers(this);" id="ContentPlaceHolder1_txtamt" placeholder="Enter UPI Amount " class="form-control">
                                    </div>
