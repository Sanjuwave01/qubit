            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add PYC Topup Fund from Trust/Metamask Wallet</h4>
                    </div>
                                    ...
                                    <div class="latest_news">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5 class="" style="font-weight: bold;">Enter No. of PYC</h5>
                                                    <input name="ctl00$ContentPlaceHolder1$txtAmount" type="text" maxlength="6" id="ContentPlaceHolder1_txtAmount" class="form-control" placeholder="Enter Coin" onkeypress="return IsNumeric(event);" onkeyup="javascript: return calculatecoininUSD();" style="">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-4">
                                                ...
                                                <button class="btn btn-warning numberonly" type="button" onclick="new_Stack_Token_Meth();" style="width: 100%;">Deposit Token</button>
                                            </div>
                                        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card " style="    margin-top: 25px;">
                    <div class="card-header">
                        <h3 class="card-title">PYC Deposit History</h3>
                    </div>
                    <div class="card-body">
