            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Deposit BUSD Into Topup Wallet ($)</h4>
                    </div>
                                    ...
                                    <div class="latest_news">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="font-weight: bold; color: black;">
                                              Enter BUSD Amount : <span id="ContentPlaceHolder1_lblcoinrate" style="font-weight:bold;"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="ctl00$ContentPlaceHolder1$txtAmount" type="text" maxlength="6" id="ContentPlaceHolder1_txtAmount" class="form-control" placeholder="Enter BUSD value" onkeypress="return IsNumeric(event);" onkeyup="javascript: return calculatecoininUSD();" style="">
