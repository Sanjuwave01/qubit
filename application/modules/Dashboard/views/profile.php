        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__group" id="kt_subheader_search">
                <span class="kt-subheader__desc" id="kt_subheader_total">
                    <?php echo $userinfo->user_id; ?> </span>
            </div>
        </div>
            ...
            <div class="kt-portlet__head">
                <div class="kt-portlet__head-toolbar">
                    <ul class="nav nav-tabs nav-tabs-space-xl nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" id="profilelink" href="#kt_apps_user_edit_tab_1" role="tab" aria-selected="false">
...
<!--                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#kt_apps_user_edit_tab_2" role="tab" aria-selected="true">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" id="passwordlink" href="#kt_apps_user_edit_tab_3" role="tab" aria-selected="false">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
<!--                        <li class="nav-item">
            ...
            <div class="kt-portlet__body">
                ...
                <div class="tab-content">
                    <div class="tab-pane" id="kt_apps_user_edit_tab_1" role="tabpanel">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4" style="padding-top:30px;">
                                                <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_apps_user_add_avatar">
                                                    <div class="kt-avatar__holder" style="background-image: url('<?php echo base_url('uploads/' . $userinfo->image); ?>');"></div>
...
//                                        pr($userinfo);
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <?php
                                                echo form_input(['type' => 'text', 'name' => 'first_name', 'class' => 'form-control', 'value' => $userinfo->first_name, 'required' => 'required']);
                                                ?>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group">
                                                    ...
                                                    <?php
                                                    echo form_input(['type' => 'number', 'name' => 'phone', 'class' => 'form-control', 'value' => $userinfo->phone, 'placeholder' => 'Phone']);
                                                    ?>
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group">
                                                    ...
                                                    <?php
                                                    echo form_dropdown('country', $countries, $userinfo->country, 'class="form-control" id="country"');
                                                    ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group">
                                                    ...
                                                    <?php
                                                    foreach ($stateArr as $key => $s)
                                                        $states[$s['id']] = $s['name'];
                                                    echo form_dropdown('state', $states, $userinfo->state, 'class="form-control" id="state"')
                                                    ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group">
                                                    ...
                                                    <?php
                                                    $cities = [];
                                                    foreach ($cityArr as $key => $c) {
                                                        $cities[$c['id']] = $c['name'];
                                                    }
//                                                    pr($cityArr);
                                                    echo form_dropdown('city', $cities, $userinfo->city, 'class="form-control" id="city"')
                                                    ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group">
                                                    ...
                                                    echo form_input(['type' => 'hidden', 'name' => 'form_type', 'value' => 'profile_btn']);
                                                    ?>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <script type="text/javascript">
                        ...
                        $('.upload-result').on('click', function (ev) {
                            $uploadCrop.croppie('result', {
                                ...
                                $.ajax({
                                    url: '<?php echo base_url('Dashboard/user/image_upload'); ?>',
                                    type: "POST",
                                    data: formData,
                    ...
                    <div class="tab-pane" id="kt_apps_user_edit_tab_3" role="tabpanel">
                        <div class="kt-form kt-form--label-right">
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        <?php echo form_open(base_url('Dashboard/User/Profile'), ['id' => 'passwordDetails']); ?>
                                        <div class="row">
                                            <label class="col-xl-3"></label>
                                            <div class="col-lg-9 col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <?php
                                                echo form_input(['type' => 'password', 'name' => 'cpassword', 'class' => 'form-control', 'placeholder' => 'Current Password']);
                                                ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <?php
                                                echo form_input(['type' => 'password', 'name' => 'npassword', 'class' => 'form-control', 'placeholder' => 'New Password']);
                                                ?>
                                            </div>
                                        </div>
                                        <div class="form-group form-group-last row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <?php
                                                echo form_input(['type' => 'password', 'name' => 'vpassword', 'class' => 'form-control', 'placeholder' => 'Verify Password']);
                                                ?>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="kt-form__actions">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <?php
                                        echo form_input(['type' => 'hidden', 'name' => 'form_type', 'value' => 'password_btn']);
                                        echo form_submit('submit', 'Save changes', 'class="btn btn-label-brand btn-bold"');
                                        echo form_close();
                                        ?>
                    ...
                    <div class="tab-pane" id="kt_apps_user_edit_tab_4" role="tabpanel">
                        <div class="kt-form kt-form--label-right">
                            <div class="kt-form__body">
                                ...
                                <div class="kt-separator kt-separator--border-dashed kt-separator--portlet-fit kt-separator--space-lg"></div>
                                <div class="kt-separator kt-separator--border-dashed kt-separator--portlet-fit kt-separator--space-lg"></div>
                                <div class="kt-section kt-section--first"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $('#<?php echo $active_tab ?>link').click();
</script>
