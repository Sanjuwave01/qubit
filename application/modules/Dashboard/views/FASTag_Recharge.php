...
<div class="container-fliud">
        <div class="row">
            <div class="col-md-12">
            	<h2 class="box-title">FASTag Recharge&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h2>
                <div class="box box-primary">
                    ...
                    <div class="row">
                                ...
                                <div class="col-md-6" style="padding-top: 10px; padding-left:30px;  padding-right:30px;">
                                    ...
                                    <div class="form-group">
                                        <label>
                                           Enter FasTag Vehicle No :<span data-val-controltovalidate="ContentPlaceHolder1_txtmobno" data-val-errormessage="Enter Mobile No." id="ContentPlaceHolder1_RequiredFieldValidator1" data-val="true" data-val-evaluationfunction="RequiredFieldValidatorEvaluateIsValid" data-val-initialvalue="" style="visibility:hidden;">*</span>
                                            :
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label>
                                            Enter Mobile No <span data-val-controltovalidate="ContentPlaceHolder1_txtamt" data-val-errormessage="Enter Recharge Amount." id="ContentPlaceHolder1_RequiredFieldValidator2" data-val="true" data-val-evaluationfunction="RequiredFieldValidatorEvaluateIsValid" data-val-initialvalue="" style="visibility:hidden;">*</span>
                                            :</label>
                                     ...
                                     <div class="form-group">
                                        <label>
                                            Recharge Amount <span data-val-controltovalidate="ContentPlaceHolder1_txtamt" data-val-errormessage="Enter Recharge Amount." id="ContentPlaceHolder1_RequiredFieldValidator2" data-val="true" data-val-evaluationfunction="RequiredFieldValidatorEvaluateIsValid" data-val-initialvalue="" style="visibility:hidden;">*</span>
                                            :</label>
