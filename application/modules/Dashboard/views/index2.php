  ...
  <ul class="nav nav-tabs nav-justified" role="tablist">
    <div class="slider"></div>
     <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false"> Portfolio</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false"> Refer </a>
      </li>
    <li class="nav-item">
            ...
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
             <div class="app-top-head">
                        ...
                        <div class="user-deatils-bg">
                            <div class="user-deatils">
                                ...
                                <div class="wallets">
                                    ...
                                    <div class="wallet-box">
                                        <a href="<?php echo base_url('Dashboard/Fund/transfer_fund') ?>" class="wallet-btn">Fund Wallets</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="package-head">
                            <a href="<?php echo base_url('Dashboard/Activation'); ?>">
                            ...
                            <a href="<?php echo base_url('Dashboard/DirectIncomeWithdraw'); ?>">
                                <div class="package-head-box">
                        ...
                        <div class="app-body">
                            ...
                            <a href="<?php echo base_url('Dashboard/Fund/upgrade_history'); ?>">
                                <div class="app-box">
                                    <img src="<?php echo base_url('uploads/data-collection.png');?>" class="img-fluid">
                                    <p>Upgrade History</p>
                                </div>
