        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="card-wrapper">
                     <a href="<?php echo base_url('Dashboard/MyRecharge/'); ?>" class="back-to-home"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                        <div class="text-center top-head-logo">
                             <a href="/" class="logo logo-admin">
                            <!-- <img src="<?php echo base_url('uploads/'); ?>logo.png" style="max-width: 150px;margin: 0;border-radius: 10px;" alt="logo"> -->
                        </a>
                        </div>
                         <div class="bg-black">
                ...
                <div class="page-header text-center">
                    ...
                    <h2 class="page-title">Recharge Successfully !</h2>


                    <?php
                    echo'<h3 class="mainboxes" style="margin-top:15px; color:#46afd7">Provider :'.$provider.' </h3>';
                     echo'<h3 class="mainboxes" style="margin-top:15px; color:#46afd7"> Mobile No.  :'.$amount.' </h3>';
                      echo'<h3 class="mainboxes" style="margin-top:15px; color:#46afd7">Amount :'.$phone.' </h3>';
                    ?>
                    <div style="font-size:20px;font-weight: bold; color:#45aed7; margin-top:20px"><a href="<?php echo base_url('Dashboard/MyRecharge/'); ?>"   style="color: white;
background: #4452cc!important;
padding: 10px 30px;
width: 100%;
font-weight:normal;
border-radius: 4px;
display: block;">Clik Here to Back  </a></div>
