                    ...
                    <ul class="clearfix">
                        <li>
                            <div class="member-img">
                                <a href="<?php echo base_url('/Dashboard/User/Pool/' . $user['user_id'] . '/' . $pool_id); ?>">
                                    <img src="https://prosquire.in/uploads/active.png">
                                </a>
                            ...
                            <ul class="clearfix">
                                ...
                                foreach ($users as $key => $direct) {
                                    ...
                                    <li>
                                        <div class="member-img">
                                            <a href="<?php echo base_url('/Dashboard/User/Pool/' . $direct['user_id'] . '/' . $pool_id); ?>">
                                                <img src="https://prosquire.in/uploads/active.png">
                                            </a>
                                        ...
                                        <ul class="clearfix">
                                            ...
                                            foreach ($direct['level_2'] as $key => $level3) {
                                                ...
                                                <li>
                                                    <div class="member-img">
                                                        <a href="<?php echo base_url('/Dashboard/User/Pool/' . $level3['user_id'] . '/' . $pool_id); ?>">
                                                            <img src="https://prosquire.in/uploads/active.png">
                                                        </a>
                                                        <span><?php echo $level3['user_id']; ?></span><br>
                                                        <span><?php //echo $level3['user_info']['name'];   ?></span>
                                                    </div>
