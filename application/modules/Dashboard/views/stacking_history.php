                          ...
                          <table class="table table-bordered table-striped dataTable" id="tableView">
                              ...
                              <tbody>
                                  ...
                                  foreach ($transactions as $key => $transaction) {
                                      if($transaction['processing'] == 0)
                                          $status = '<span style="color:blue; font-weight:bold">Pending</span>';
                                      elseif($transaction['processing'] == 1)
                                          $status = '<span style="color:green; font-weight:bold">Approved</span>';
                                      elseif($transaction['processing'] == 2)
                                          $status = '<span style="color:red; font-weight:bold">Rejected</span>';
                                      ?>
                                      <tr>
                                          <td><?php echo ($key + 1) ?></td>
                                          <td><?php echo $transaction['user_id']; ?></td>
                                          <td><?php echo $transaction['amount']. ' Stacking Reward Withdrawal' ; ?></td>
                                          <td><?php echo ucwords(str_replace('_', ' ', $transaction['type'])); ?></td>
                                          <td><?php echo $status; ?></td>

                                          <td><?php echo $transaction['admin_charges'] . ' Stacking Reward Withdrawal'; ?></td>
                                          <!-- <td><?php //echo $transaction['tds']; ?></td> -->
                                          <td><?php echo $transaction['payable_amount'] . ' Stacking Reward Withdrawal'; ?></td>
