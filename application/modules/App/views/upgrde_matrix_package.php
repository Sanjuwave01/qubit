...
<div class="container-fulid">
    ...
    <!-- BEGIN wizard -->
     <div class="card">
          ...
          <span style="font-size:20px; color:#000">  Wallet balance (USDT <?php echo $wallet['wallet_balance']; ?>) </span>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="package_id" id="PackageId">
                                ...
                                //     echo'<option value="'.$package['id'].'" data-price="'.$package['price'].'">'.$package['title'].' ($ '.$package['price'].')</option>';
                                // }
                                ?>
                            </select>
                        </div>
...
<script>
    ...
    if (user_id != '') {
        var url = '<?php echo base_url("Dashboard/check_pool_packages/") ?>' + user_id;
        var html = '';
        $.get(url, function(res) {
            ...
            $.each(res.packages,function(key,value){
                html +='<option value="'+ value.id +'">'+value.title+' With USDT ' + value.price+' </option>';
            })
            $('#PackageId').html(html);
        },'json')
    }
