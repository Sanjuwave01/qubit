                        ...
                        <div class="user-deatils-bg">
                            <div class="user-deatils">
                                ...
                                <div class="wallets">
                                    ...
                                    <a href="<?php echo base_url('App/User/mainWallet') ?>" class="wallet-btn">Main Wallets</a>
                                    </div>
                                    <div class="wallet-box">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- <div class="row">
                            <div class="col-xl-12 col-md-12">
                                <h4 class="text-center">Clicke <a href="<?php echo base_url('App/UpgradeMatrixPackage');?>">Here</a> to Upgrade to Matrix Pool</h4>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-4">
                                            <div class="float-left d-none mini-stat-img mr-4">
                                                <img src="<?php echo base_url('NewApp/');?>assets/images/services-icon/01.png" alt="">
                                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card mini-stat bg-primary text-white" style="background:linear-gradient(87deg,#11cdef,#1171ef)!important;">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            <div class="float-left d-none mini-stat-img mr-4">
                                                <img src="<?php echo base_url('NewApp/');?>assets/images/services-icon/02.png" alt="">
                                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card mini-stat bg-primary text-white" style="background:linear-gradient(87deg,#f5365c,#f56036)!important">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            <div class="float-left d-none mini-stat-img mr-4">
                                                <img src="<?php echo base_url('NewApp/');?>assets/images/services-icon/03.png" alt="">
                                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card mini-stat bg-primary text-white" style="background:#f0466b !important">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            <div class="float-left d-none mini-stat-img mr-4">
                                                <img src="<?php echo base_url('NewApp/');?>assets/images/services-icon/04.png" alt="">
                                            </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row copyReferal box box-body pull-up bg-hexagons-white">
              ...
              value="<?php echo base_url('App/User/Register/?sponser_id='.$userinfo->user_id); ?>"
              class="form-control">
...
<script>
$('#myModal').modal('show');
// $.get('<?php echo base_url('App/User/get_coin_prices')?>',function(res){
//   console.log(res)
//   // var html = '';
