        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="search-bar bg-white">
                    <form action="<?php echo base_url('App/User/GenelogyTree/');?>" id="srchform" method="GET">
                        <div class="row">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td colspan="4" align="left" class="red2">
                                                                          <font id="right_team">Left Team : </font>
                                                                            <font id="left_team"><?php echo $level1->left_count;?></font>
                                                                        </td>
                                                                        <td align="right" class="red2"><font id="right_team">Right
                                                                                Team : </font>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="4" align="left" class="red2">
                                                                            <font id="right_team">Left ZS : </font>
                                                                            <font id="left_matching"><?php echo $level1->leftBusiness;?></font>
                                                                        </td>
                                                                        <td align="right" class="red2">
                                                                            <font id="right_team">Right
                                                                            ZS : </font>
                                                        ...
                                                        <td colspan="2" align="center">
                                                            <a href="#" class="has-tooltip">
                                                                ...
                                                                <span class="on-hover">
                                                                    ...
                                                                    Left points : <?php echo $level1->leftPower;?> | Right points : <?php echo $level1->rightPower;?> <br>
                                                                    ...
                                                                    <tr valign="top">
                                                                        ...
                                                                        if(!empty($level2[1]->user_id)){
                                                                            echo'<td id="p1" width="50%" align="center">
                                                                                <a href="'.base_url('App/User/GenelogyTree/'.$level2[1]->user_id).'" class="has-tooltip">
                                                                                    <img src="'.tree_img($level2[1]->package_amount,0).'" alt="'. $level2[1]->name.'" border="0" width="60">
                                                                                    <span class="on-hover">
                                                                                        Username : '. $level2[1]->name.' <br>
                                                                                        Sponsor ID : '. $level2[1]->sponser_id.' <br>
                                                                                        ...
                                                                                        Left points : '.$level2[1]->leftPower.' | Right points : '.$level2[1]->rightPower.' <br>
                                                                            ...
                                                                            echo'<td  id="p1" width="50%" align="center">';
                                                                                echo'<a href="'.base_url('App/User/Register/?sponser_id='.$this->session->userdata['user_id'].'&position=L').'">
                                                                        ...
                                                                        if(!empty($level2[2]->user_id)){
                                                                            echo'<td id="p1" width="50%" align="center">
                                                                                <a href="'.base_url('App/User/GenelogyTree/'.$level2[2]->user_id).'" class="has-tooltip">
                                                                                    <img src="'.tree_img($level2[2]->package_amount,0).'" alt="'. $level2[2]->name.'" border="0" width="60">
                                                                                    <span class="on-hover">
                                                                                        Username : '. $level2[2]->name.' <br>
                                                                                        Sponsor ID : '. $level2[2]->sponser_id.' <br>
                                                                                        ...
                                                                                        Left points : '.$level2[2]->leftPower.' | Right points : '.$level2[2]->rightPower.' <br>
                                                                            ...
                                                                            echo'<td  id="p1" width="50%" align="center">';
                                                                                echo'<a href="'.base_url('App/User/Register/?sponser_id='.$this->session->userdata['user_id'].'&position=R').'">
                                                                                    <img src="'.tree_img(0,1).'" alt="waiting" border="0" width="60"><br>
                                                                                    <span class="on-hover">
                                                                    ...
                                                                    <tr align="center">
                                                                        ...
                                                                        if(!empty($level3[1]->user_id)){
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                <a href="'.base_url('App/User/GenelogyTree/'.$level3[1]->user_id).'" class="has-tooltip">
                                                                                    <img src="'.tree_img($level3[1]->package_amount,0).'" alt="'. $level3[1]->name.'" border="0" width="60">
                                                                                    <span class="on-hover">
                                                                                        Username : '. $level3[1]->name.' <br>
                                                                                        Sponsor ID : '. $level3[1]->sponser_id.' <br>
                                                                                        ...
                                                                                        Left points : '.$level3[1]->leftPower.' | Right points : '.$level3[1]->rightPower.' <br>
                                                                        ...
                                                                        if(!empty($level3[2]->user_id)){
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                    <a href="'.base_url('App/User/GenelogyTree/'.$level3[2]->user_id).'" class="has-tooltip">
                                                                                        <img src="'.tree_img($level3[2]->package_amount,0).'" alt="'.$level3[2]->name.'" border="0" width="60">
                                                                                        <span class="on-hover">
                                                                                            Username : '. $level3[2]->name.' <br>
                                                                                            Sponsor ID : '. $level3[2]->sponser_id.' <br>
                                                                                            ...
                                                                                            Left points : '.$level3[2]->leftPower.' | Right points : '.$level3[2]->rightPower.' <br>
                                                                        ...
                                                                        if(!empty($level3[3]->user_id)){
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                    <a href="'.base_url('App/User/GenelogyTree/'.$level3[3]->user_id).'" class="has-tooltip">
                                                                                        ...
                                                                                        <span class="on-hover">
                                                                                            ...
                                                                                            Left points : '.$level3[3]->leftPower.' | Right points : '.$level3[3]->rightPower.' <br>
                                                                        ...
                                                                        if(!empty($level3[4]->user_id)){
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                    <a href="'.base_url('App/User/GenelogyTree/'.$level3[4]->user_id).'" class="has-tooltip">
                                                                                        ...
                                                                                        <span class="on-hover">
                                                                                            ...
                                                                                            Left points : '.$level3[4]->leftPower.' | Right points : '.$level3[4]->rightPower.' <br>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr align="center" valign="top">
                                                                                        ...
                                                                                        if(!empty($level4[1]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('App/User/GenelogyTree/'.$level4[1]->user_id).'" class="has-tooltip">
                                                                                        ...
                                                                                        if(!empty($level4[2]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('App/User/GenelogyTree/'.$level4[2]->user_id).'" class="has-tooltip">
                                                                                        ...
                                                                                        if(!empty($level4[3]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('App/User/GenelogyTree/'.$level4[3]->user_id).'" class="has-tooltip">
                                                                                        ...
                                                                                        if(!empty($level4[4]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('App/User/GenelogyTree/'.$level4[4]->user_id).'" class="has-tooltip">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr align="center" valign="top">
                                                                                        ...
                                                                                        if(!empty($level4[5]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('App/User/GenelogyTree/'.$level4[5]->user_id).'" class="has-tooltip">
                                                                                        ...
                                                                                        if(!empty($level4[6]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                <a href="'.base_url('App/User/GenelogyTree/'.$level4[6]->user_id).'" class="has-tooltip">
                                                                                        ...
                                                                                        if(!empty($level4[7]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('App/User/GenelogyTree/'.$level4[7]->user_id).'" class="has-tooltip">
                                                                                        ...
                                                                                        if(!empty($level4[8]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('App/User/GenelogyTree/'.$level4[8]->user_id).'" class="has-tooltip">
