                ...
                foreach ($users as $key => $user) {
                    ...
                    <div class="boxesmain">
                      <div style="float: left;font-weight:bold;color:#000;width: 75%;text-transform: capitalize;">
                            <b>User id:</b> <?php echo $user['userinfo']['user_id']; ?>
                            <br><b>Name:</b> <?php echo $user['userinfo']['name']; ?>

                          <p><b>Joining Date:</b> <?php echo $user['userinfo']['created_at']; ?></p>
                          <p style="font-weight: normal;color: #000;font-weight: 600;"><b>Activation Date:</b> <?php echo $user['userinfo']['topup_date']; ?></p>
                      </div>
