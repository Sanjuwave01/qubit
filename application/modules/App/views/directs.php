...
<style>
    ...
    .dataTables_wrapper .dataTables_length select {
        background-color: #402b8c !important;
...
<div class="mt-4">
    ...
    <div class="row">
        <div class="col-md-12">
                ...
                foreach ($users as $key => $user) {
                    ...
                    <div class="boxesmain">
                      <div style="float: left;font-weight:bold;color:#000;width: 75%;text-transform: capitalize;">
                            <b>User id : </b> <?php echo $user['user_id']; ?>
                            </br><b>Name : </b> <?php echo $user['name']; ?>

                          <p><b>Joining Date:</b> <?php echo $user['created_at']; ?></p>
                          <p style="font-weight: normal;color: #000;font-weight: 600;"><b>Activation Date:</b> <?php echo $user['topup_date']; ?></p>
                      </div>
                      <?php if($user['userinfo']['package_amount'] > 0):?>
                          <div style="float: right;width:25%;background: #2a9737!important;color: #fff;text-align: center;padding: 5px 0;border-radius: 4px;"> 
                          Zil <?php echo $user['userinfo']['package_amount']; ?>
                          </div>
                      <?php else:?>
                       <div style="float: right;width:25%;background: #e73c16!important;color: #fff;text-align: center;padding: 5px 0;border-radius: 4px;"> 
                          Zil <?php echo $user['userinfo']['package_amount']; ?>
                          </div>
                      <?php endif;?>
            ...
            ?>
            <div class="box box-solid bg-black" style="display: none;">
      <div class="box-body">
