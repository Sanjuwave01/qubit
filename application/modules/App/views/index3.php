           ...
           <!--    <nav aria-label="breadcrumb">
            ...
            <!-- start page title -->
                        <div class="row align-items-center">
                            <div class="col-sm-12">
                                <div class="page-title-box card card-body mb-4 box-bg">
            ...
            <div class="row">
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white box-bg">
                  <div class="card-body">
                    <img src="<?php echo base_url('');?>assets/images/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">E wallet <i class="mdi mdi-diamond mdi-24px float-right"></i>
                    </h4>
                    <h2><?php echo $wallet_balance['wallet_balance'];?> ZiL</h2>
                  </div>
                </div>
              </div>
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white box-bg">
                  <div class="card-body">
                    <img src="<?php echo base_url('');?>assets/images/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Current Package <i class="mdi mdi-diamond mdi-24px float-right"></i>
                    </h4>
                    <h2> <span ><?php echo $userinfo->package_amount; ?> ZiL</h2>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card card-img-holder text-white box-bg" style="background: linear-gradient(87deg,#5e72e4,#825ee4);">
                  <div class="card-body">
                    <img src="<?php echo base_url('');?>assets/images/circle.svg" class="card-img-absolute" alt="circle-image" />
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card card-img-holder text-white box-bg" style="background:linear-gradient(87deg,#f5365c,#f56036)">
                  <div class="card-body">
                    <img src="<?php echo base_url('');?>assets/images/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Daily Trade Profit<i class="mdi mdi-diamond mdi-24px float-right"></i>
                    </h4>
                    <h2> <span ><?php echo number_format($self_income['self_income'], 2); ?></span> ZiL</h2>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card card-img-holder text-white box-bg" style="background:linear-gradient(87deg,#172b4d,#1a174d)">
                  <div class="card-body">
                    ...
                    <h2> <span ><?php echo number_format($matching_bonus['matching_bonus'], 2); ?></span> ZiL</h2>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card card-img-holder text-white box-bg" style="background:linear-gradient(316deg, #fc5286, #fbaaa2)">
                  <div class="card-body">
                    ...
                    <h2> <span ><?php echo number_format($royalty_income['royalty_income'], 2); ?></span> ZiL</h2>
                  </div>
                </div>
              </div>
              <div class="col-md-4 stretch-card grid-margin">
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card card-img-holder text-white box-bg" style="background:linear-gradient(135deg, #ffc480, #ff763b)">
                  <div class="card-body">
                    <img src="<?php echo base_url('');?>assets/images/circle.svg" class="card-img-absolute" alt="circle-image" />
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card card-img-holder text-white box-bg" style="background:linear-gradient(to bottom, #0e4cfd, #6a8eff)">
                  <div class="card-body">
                    <img src="<?php echo base_url('');?>assets/images/circle.svg" class="card-img-absolute" alt="circle-image" />
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card card-img-holder text-white box-bg" style="background:linear-gradient(0deg,#0098f0,#00f2c3)">
                  <div class="card-body">
                    <img src="<?php echo base_url('');?>assets/images/circle.svg" class="card-img-absolute" alt="circle-image" />
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card card-img-holder text-white box-bg" style="background:#33db9e">
                  <div class="card-body">
                    <img src="<?php echo base_url('');?>assets/images/circle.svg" class="card-img-absolute" alt="circle-image" />
