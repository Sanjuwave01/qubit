<?php include_once('header.php'); ?> <style>
  ...
  .search-sec .col-lg-2:first-child {
    border: 0;
  }
  ...
  .sec-center .other-detail li:nth-child(2):before,
  .sec-center .other-detail li:nth-child(3):before {
    content: '';
    background: #00877e;
    width: 4px;
    top: 9px;
              ...
              <div class="col-md-12"> 
                ...
                <div class="boxesmain">
                  <div style="float: left;font-weight:bold;color:#000;width: 75%;text-transform: capitalize;">
                    <b>Level:</b> <?php echo $user['level']; ?> 
                  </div>
                  <div style="float: right;width:25%;background: #03657e!important;color: #fff;text-align: center;padding: 5px 0;border-radius: 4px;"> <?php echo $user['team']; ?> </div>
                  <div>
                        <a href="<?php echo base_url('App/Network/directReport/'.$user['level']);?>" class="view-btn">View</a>
                  </div>
                </div> 
                <?php
                    }
