    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title" style ="color:#000;font-size: 20px;">
                   ZIL Withdraw Request (ZIL<?php echo $balance['balance'];?>)
                </h3>
            </div>
        </div>
        <div class="kt-portlet__body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label>Address</label>
                        <input type="text" class="form-control" name="address" placeholder="Zil Address" required="required">
                    </div>
                    <!-- <div class="form-group">
                        <div class="row">
                            <div class="col-md-4">
