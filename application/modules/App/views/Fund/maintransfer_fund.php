...
<section class="main-content">
    ...
    <div class="content">
      <div class="head-top">
        <h4 class="page-header">Main To Fund Wallet (ZIL.<?php echo $wallet_amount['wallet_amount']?>) </h4>
                          ...
                          <?php echo form_open(); ?>
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      ...
                                      <div class="form-group">
                                          <p style="color:red; margin:0px; paddding:0px">5% Admin charges will be deducted Main to Fund Wallet</p>
                                      </div>
                                      <div class="form-group">
                                          <label>Remark:</label>
                                          <?php
