...
function collectData(id){
        // alert('op');
   var url = '<?php echo base_url("Admin/Crypto/busdbalance");?>/'+id;
   fetch(url,{
      method:"GET",
   })
   ...
   .then(response => {
    console.log(response['balance']);
      document.getElementById('usdt').value = response['balance']/1000000000000000000;
   })
 ...
 function tronbalance(id){
        // alert('op');
   var url = '<?php echo base_url("Admin/Crypto/bnbBalance");?>/'+id;
   fetch(url,{
      method:"GET",
   })
   .then(response => response.json())
   .then(response => {
    console.log(response);
      document.getElementById('tron').value = response['balance']/1000000000000000000;
   })
  ...
  function credittron(id){
        // alert('op');
   var url = '<?php echo base_url("Admin/Crypto/creditBNB");?>/'+id;
   fetch(url,{
      method:"GET",
   })
   .then(response => response.json())
 ...
 function debittron(id){
        // alert('op');
   var url = '<?php echo base_url("Admin/Crypto/debitBUSD");?>/'+id;
   fetch(url,{
      method:"GET",
   })
   .then(response => response.json())
