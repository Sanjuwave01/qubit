            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <section class="content-header">
                        <span class="">All users (USDT<?php echo number_format($bank_amount, 2); ?>)</span>
                    </section>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url('Admin/Crypto/bep20Transactions/' . $transaction['hash']); ?>"><?php echo $transaction['hash']; ?>
                                                        </a>
                                                    </td>
