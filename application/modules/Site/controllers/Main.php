...
class Main extends CI_Controller {
    ...
    public function Blog() {
            ...
            $query = $this->db->get();        
            $response['blogs']=$query->result();   
            $this->load->view('blog.php',$response);
  	 ...
  	 public function ViewBlogDetails($blog_id) {
        ...
        $query=$this->db->get(); 
        $data['blog_details'] = $query->result(); 
    
        // Load the view with blog details
         $this->load->view('read-more.php',$data);
    }
