  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-4">
        ...
        <p>Talk to us now on Skype <span>BTTearn.us</span> </p>
        <p>Or drop us a line at</p>
        <a href="#">info@bttearn.us</a> </div>
      <div class="col-sm-4">
        <h3>Useful Links</h3>
        <ul>
          <li><a href="<?php echo base_url('SiteAssets/'); ?>assets/site/images/ProSquire-whitepaper.pdf" target="_blank">WHITEPAPER</a></li>
      ...
      <div class="col-sm-4">
        ...
        <div class="socail-account">
          <ul>
            <li><a href="https://www.facebook.com/bttearn.us/" target="_blank"><i class="fb-icon"></i></a></li>
            <li><a href="https://www.instagram.com/bttearn.us/" target="_blank"><i class="insta-icon"></i></a></li>
            <li><a href="https://in.pinterest.com/1bttearnfx.us/" target="_blank"><i class="p-icon"></i></a></li>
            <li><a href="https://twitter.com/bttearn.us" target="_blank"><i class="tw-icon"></i></a></li>
            <li><a href="https://www.youtube.com/channel/UCOFBv1JPJD_g6O1_2T7yWnQ" target="_blank"><i class="yt-icon"></i></a></li>
            <li><a href="https://www.linkedin.com/company/bttearn.us-coin/" target="_blank"><i class="in-icon"></i></a></li>
          </ul>
        </div>
      </div>
      <div class="col-sm-12">
        <div class="copy-right">
          <p>2021 © bttearn.us All Rights Reserved.</p>
        </div>
      </div>
    </div>
  </div>
